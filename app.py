...
st.set_page_config(page_title="개인 맞춤 식단 설계 프로그램") st.title("🥗 개인 맞춤 식단 설계 프로그램")
...
def save_log(log): with open("meals_log.json", "w") as f: json.dump(log, f, ensure_ascii=False, indent=2)
